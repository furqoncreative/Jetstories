...
class NetworkLoginRepositoryTest {
    ...
    @Test
    fun givenInvalidEmailAndInvalidPasswordThenShouldFail() = runTest {
        ...
        assertEquals(
            expectedResult, repository.loginUser(email = "email.com", password = "1234")
        )
    }

    @Test
    fun givenInvalidEmailAndValidPasswordThenShouldFail() = runTest {
        val actualResult = LoginResponse(
            error = true, message = "\\\"email\\\" must be a valid email", loginResult = null
        )
        ...
        assertEquals(
            expectedResult, repository.loginUser(email = "email.com", password = "12345678")
        )
    }

    @Test
    fun givenValidEmailAndInvalidPasswordThenShouldFail() = runTest {
        val actualResult = LoginResponse(
        ...
        assertEquals(
            expectedResult, repository.loginUser(email = "test@email.com", password = "123456789")
        )
    }

    @Test
    fun givenValidEmailAndPasswordLessThanEightThenShouldFail() = runTest {
        val actualResult = LoginResponse(
            error = true,
        ...
        assertEquals(
            expectedResult, repository.loginUser(email = "test@email.com", password = "123456")
        )
    }

    @Test
    fun givenValidEmailAndValidPasswordThenShouldSuccess() = runTest {
        val actualResult = LoginResponse(
        ...
        assertEquals(
            expectedResult, repository.loginUser(email = "test@email.com", password = "12345678")
        )
    }
}
